...
import { desVariants, fadeInUpVariants, tagVariants, titileVariants } from "@/utils/animation";
const page = () => {
  ...
  return (
    <div>
      <motion.div
        ...
        className="bg-[url('/whoweare.jpg')] bg-center bg-cover"
      >
      ...
      <div className="container">
        <div className="pt-4">
          ...
          >
            We have great idea & I Interior Design
          </motion.h2>
          <motion.p
            initial="offscreen"
            whileInView={"onscreen"}
        ...
        <div className="items-center lg:flex gap-x-4">
          <motion.div style={{ scale }} ref={ref} className="w-full">
            <Image src="/gallery1123.jpg" width={700} height={700} alt="" />
          </motion.div>
          ...
          <div>
            ...
            >
              ...
              <br /> We are an international Architects. We believe that today
              it is fundamental to totally rethink archi-tectural education.
              Confluence not only integrates new visions on society but also
              incorporates new methods and contemporary tools linked to
              creativity, production and communication. De-signed and
              handcrafted to hold and showcase my year two architecture
