      ...
      <div className="container lg:grid lg:grid-cols-2 py-14">
        ...
        >
          ...
          <div className="relative lg:max-w-sm">
            ...
            <button className="absolute bg-black text-white rounded-full h-10 hover:border-black px-3 text-sm top-2 right-2 hover:border-2 ■hover:bg-white hover:text-black dark:bg-primary ">
              Subscribe
            </button>
          </div>
